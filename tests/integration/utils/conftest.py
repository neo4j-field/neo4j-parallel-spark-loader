...
def bipartite_spark_dataframe(spark_fixture: SparkSession) -> DataFrame:
    ...
    data = [
        {"source": "a", "target": "c", "prop": 0, "final_group": 0, "batch": 0},
        {"source": "a", "target": "d", "prop": 1, "final_group": 0, "batch": 1},
        {"source": "b", "target": "c", "prop": 2, "final_group": 1, "batch": 1},
        {"source": "b", "target": "d", "prop": 3, "final_group": 1, "batch": 0},
        {"source": "b", "target": "e", "prop": 4, "final_group": 0, "batch": 2},
    ]
