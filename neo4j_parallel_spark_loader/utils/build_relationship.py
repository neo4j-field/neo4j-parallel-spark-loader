...
from neo4j_parallel_spark_loader.bipartite import group_and_batch_spark_dataframe as group_and_batch_bipartite
from neo4j_parallel_spark_loader.predefined_components import group_and_batch_spark_dataframe as group_and_batch_predefined
...
def build_relationship(
    ...
    if group_keys and len(group_keys) > 0 and df.count() > max_serial:
        ...
        if len(group_keys)==1:
            ...
            batched_df = group_and_batch_bipartite(df, group_keys[0],group_keys[1], num_groups)
